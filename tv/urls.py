...
from .views import TVDetailsAPI, TVCreditsAPI, TVRecommendationsAPI, TVSimilarAPI, TVPopularAPI, TVDiscoverAPI, TVTopRatedAPI, TVVideosAPI, TVProvidersAPI, TVSeasonDetailsAPI, TVSeasonVideosAPI 
